...
import { surveyApi, type CsiSummary, type RecentSurvey } from '@/lib/surveyApi';
    ...
    return (
      <Card className={cardClass}>
        <CardContent className="p-8 text-center">
          ...
          <p className="text-blue-200 text-sm mb-4">Pastikan server berjalan dengan npm run dev</p>
          <Button
            onClick={loadData}
